...
$scheme = csco_color_scheme(
	get_theme_mod( 'color_search_background', '#000000' ),
	...
	<div class="cs-container">
		<form role="search" method="get" class="cs-search__nav-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			<div class="cs-search__group">
				...
				<input data-swpparentel=".cs-header .cs-search-live-result" required class="cs-search__input" data-swplive="true" type="search" value="<?php the_search_query(); ?>" name="s" placeholder="<?php echo esc_attr( get_theme_mod( 'misc_search_placeholder', __( 'Enter your search topic', 'newsblock' ) ) ); ?>">
			...
			if ( get_theme_mod( 'header_search_posts', true ) ) {
				...
				if ( $items->have_posts() ) {
					...
					<div class="cs-search__posts">
						<?php csco_section_heading( get_theme_mod( 'header_search_posts_heading', esc_html__( 'The Latest', 'newsblock' ) ) ); ?>
								...
								<article <?php post_class(); ?>>
									<div class="cs-entry__outer">
										...
										<div class="cs-entry__inner cs-entry__content">
											<?php the_title( '<div class="cs-entry__title"><a href="' . esc_url( get_permalink() ) . '">', '</a></div>' ); ?>
